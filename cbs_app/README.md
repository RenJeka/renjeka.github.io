...
3. Заполнение объекта. (Если мы не хотим, чтобы значение 'value' у поля ввода попало в заполняемый объект -- необходимо добавить атрибут 'ignore' в html - элемент)
...
- Заполнить html-файл по шаблону, добавив в форму поле с метаданными <input type="hidden" ...>
