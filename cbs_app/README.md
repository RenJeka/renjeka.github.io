...
6. Данных сохраняются в локальном хранилище браузера (LocalStorage). Данные будут хранится до тех пор, пока вы самостоятельно не очистите локальное хранилище. В случае удаления браузера, либо сбоя системы данные могут удалиться. 
