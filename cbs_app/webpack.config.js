...
let JekaWebpackConfiguration = {
	...
	output:{
		...
		filename: '[name].js', // Свойство позволяет настроить, как будет называться итоговые название (выходящего) файлов. Название бандла
		// publicPath: 'dist/' // Публичный путь (разобраться зачем он нужен)
	},
	...
	module:{
		...
		rules:[
			...
			// 1. Когда применяется 'style-loader' + 'css-loader'.
			// 2. Когда применяется специальный плагин "extract-text-webpack-plugin" + 'css-loader'
			{
				test:/\.css$/,
				////-----------------------------------------------------------------------
